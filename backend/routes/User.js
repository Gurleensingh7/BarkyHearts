...
const { registerUser, loginUser, addToCart, getCartItems, removeCartItem, getUserOrders, updateUserPassword,getAllUsersWithOrders ,updateCartQuantity,placeOrder} = require('../controller/User');
